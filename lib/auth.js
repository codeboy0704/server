...
exports.signup = exports.signin = exports.newToken = void 0;
...
function verifyPassword(password, hashPassword) {
  return new Promise(function (resolve, reject) {
    _bcrypt["default"].compare(password, hashPassword, function (err, same) {
      if (err) {
        return reject(err);
      }
      resolve(same);
...
var newToken = exports.newToken = function newToken(user) {
  return _jsonwebtoken["default"].sign({
    id: user.id
  }, _config.config.ACCESS_TOKEN_SECRET, {
    expiresIn: "1d"
  });
};
var verifyToken = exports.verifyToken = function verifyToken(token) {
  return new Promise(function (resolve, reject) {
    _jsonwebtoken["default"].verify(token, _config.config.ACCESS_TOKEN_SECRET, function (err, payload) {
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body, name, password, email, userData, user, token, err;
...
var signin = exports.signin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var _req$body2, name, password, user, match, token, error;
